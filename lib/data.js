// ─── Voice Samples ────────────────────────────────────────────────────────────
// Add audio file paths to `src` once recordings are ready (e.g. '/audio/law-firm.mp3')

export const voiceSamples = [
  { id: 'law-firm',       delay: '',   industry: 'Law Firm',            scenario: 'New Client Enquiry',      duration: '0:32', src: null },
  { id: 'medical',        delay: 'd1', industry: 'Medical Clinic',      scenario: 'Appointment Booking',     duration: '0:28', src: null },
  { id: 'auto-shop',      delay: 'd2', industry: 'Auto Shop',           scenario: 'Service Scheduling',      duration: '0:41', src: null },
  { id: 'fitness',        delay: '',   industry: 'Fitness Studio',      scenario: 'Membership Enquiry',      duration: '0:25', src: null },
  { id: 'hotel',          delay: 'd1', industry: 'Hotel & Hospitality', scenario: 'Reservation Handling',    duration: '0:35', src: null },
  { id: 'home-services',  delay: 'd2', industry: 'Home Services',       scenario: 'Urgent Service Call',     duration: '0:29', src: null },
];
